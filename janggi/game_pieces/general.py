...
class General(GamePiece):
    """
    Represents the 'General' game piece.
    """
    ...
    def get_valid_moves(self, board):
        """
        Returns a list of all valid moves the General GamePiece can make from its current position. Specifically, positions will be 
